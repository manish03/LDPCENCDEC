...
set_input_delay -min 5.86 -clock [get_clocks {clk}] [get_ports {P_inputnoutput}]
set_input_delay -min 5.86 -clock [get_clocks {clk}] [get_ports {P_input}]
set_input_delay -min 5.86 -clock [get_clocks {clk}] [get_ports {P_in_out_sel[*]}]
...
set_output_delay -max 3.62 -clock [get_clocks {clk}] [get_ports {PO_output}]
