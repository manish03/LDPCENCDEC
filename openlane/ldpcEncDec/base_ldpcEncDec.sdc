...
set_input_delay -max 4.89 -clock [get_clocks {clk}] [get_ports {P_input}]
#set_input_delay -max 4.89 -clock [get_clocks {clk}] [get_ports {PO_output}]
set_input_delay -max 4.89 -clock [get_clocks {clk}] [get_ports {P_inputnoutput}]
set_input_delay -max 4.89 -clock [get_clocks {clk}] [get_ports {P_in_out_sel[*]}]
...
set_input_delay -min 4.3  -clock [get_clocks {clk}] [get_ports {P_input}]
#set_input_delay -min 4.3  -clock [get_clocks {clk}] [get_ports {PO_output}]
set_input_delay -min 4.3  -clock [get_clocks {clk}] [get_ports {P_inputnoutput}]
set_input_delay -min 4.3  -clock [get_clocks {clk}] [get_ports {P_in_out_sel[*]}]
...
# Input Transition
set_input_transition -max 0.14  [get_ports {P_input}]
set_input_transition -max 0.14  [get_ports {PO_output}]
set_input_transition -max 0.14  [get_ports {P_inputnoutput}]
set_input_transition -max 0.14  [get_ports {P_in_out_sel[*]}]
...
set_input_transition -min 0.07  [get_ports {P_input}]
set_input_transition -min 0.07  [get_ports {PO_output}]
set_input_transition -min 0.07  [get_ports {P_inputnoutput}]
set_input_transition -min 0.07  [get_ports {P_in_out_sel[*]}]
...
# Output delays
set_output_delay -max 0.7  -clock [get_clocks {clk}] [get_ports {PO_output}]
...
set_output_delay -min 0    -clock [get_clocks {clk}] [get_ports {PO_output}]
